...
# YOLO model path relative to the current file
BASE_DIR = dirname(__file__)
MODEL_PATH = join(BASE_DIR, "assets", "yolo", "dataset", "license_plate_detector.pt")

from ultralytics import YOLO
model = YOLO(MODEL_PATH)

# Load easyocr (English and Portuguese)
...
def extract_plate_text(ocr_results):
    ...
    # Regex for old and new Brazilian license plates
